...
str(sugarmaple)
class(sugarmaple)
sydney <- setLocation(lat=-33.8, long=151.2)
plot(sydney)
sunnyday <- setMet(sydney, month=12, day=12, nsteps=12, Tmin=12, Tmax=28, PARday=24)

plot(sunnyday)
setPhy

clidlrc <- setPhy("lightresponse",
leafpars=list(Amax=8.5, Rd=0.7, phi=0.045, theta=0.95, reflec=0.1, transmit=0.05))
YplantDay
...
coneplant <- constructplant(randomplant(radius=250, height=500, 
leaflen=25, LA=1))
